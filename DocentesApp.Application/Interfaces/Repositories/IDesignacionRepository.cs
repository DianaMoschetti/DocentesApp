...
namespace DocentesApp.Application.Interfaces.Repositories
{
    public interface IDesignacionRepository
    {
        ...
        // (Docente, Cargo, Dedicacion) para armar el listado
        ...
        // Valida la regla 33: no pueden existir dos designaciones activas DIANA VER
        // con la misma combinación docente-cargo
